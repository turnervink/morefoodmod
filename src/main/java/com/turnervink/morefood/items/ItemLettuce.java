...
public class ItemLettuce extends ItemSeedFood {
    ...
    public ItemLettuce(String name, int restoreAmount, float saturation) {

        super(restoreAmount, saturation, BlockHandler.lettuceCrop, Blocks.FARMLAND);
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn,
        ...
        {
            worldIn.setBlockState(pos.up(), BlockHandler.lettuceCrop.getDefaultState(), 11);
            itemstack.shrink(1);
    ...
    public IBlockState getPlant(IBlockAccess world, BlockPos pos) {
        ...
        return BlockHandler.lettuceCrop.getDefaultState();
