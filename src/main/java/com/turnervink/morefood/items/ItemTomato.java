...
public class ItemTomato extends ItemSeedFood {
    ...
    public ItemTomato(String name, int restoreAmount, float saturation) {

        super(restoreAmount, saturation, BlockHandler.tomatoCrop, Blocks.FARMLAND);
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn,
        ...
        {
            worldIn.setBlockState(pos.up(), BlockHandler.tomatoCrop.getDefaultState(), 11);
            itemstack.shrink(1);
    ...
    public IBlockState getPlant(IBlockAccess world, BlockPos pos) {
        ...
        return BlockHandler.tomatoCrop.getDefaultState();
